          ...
          <div class="mb-4">
            ...
            <ul class="space-y-1">
              @for (achievement of experience().achievements; track achievement) {
                <li class="flex items-start gap-2 text-sm text-secondary-700 dark:text-secondary-300">
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              @for (tech of experience().technologies; track tech) {
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-secondary-100 text-secondary-800 dark:bg-secondary-700 dark:text-secondary-200">
                  {{ tech }}
                </span>
              }
            </div>
